...
class Display extends React.Component {
    setStyle = (gs) => {
        this.setState({style : {height : gs*19,},});
    };
    dragOver = (e) => {
        e.preventDefault();
    ...
    mouseMoveFunc = (e) => {
        if (this.props.mouseMoveFunc) this.props.mouseMoveFunc(e);
    };
    ...
    render () {
        let loadingDisplay = {display : 'none',};
        if (this.props.loading) loadingDisplay = {display : 'inline-block',};
        return (
